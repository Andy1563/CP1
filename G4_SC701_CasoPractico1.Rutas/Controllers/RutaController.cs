...
namespace G4_SC701_CasoPractico1.Rutas.Controllers
{
    public class RutaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreRuta,Estado,IdParada,FechaRegistro,IdUsuarioRegistro")] Ruta ruta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreRuta,Estado,IdParada,FechaRegistro,IdUsuarioRegistro")] Ruta ruta)
        {
            if (id != ruta.Id)
            {
                return NotFound();
